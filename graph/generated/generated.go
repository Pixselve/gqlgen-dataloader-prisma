...
type ComplexityRoot struct {
	Mutation struct {
		CreateOnePost func(childComplexity int, authorUsername string, title string) int
		CreateOneUser func(childComplexity int, username string) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createOnePost":
		if e.complexity.Mutation.CreateOnePost == nil {
			break
		}

		args, err := ec.field_Mutation_createOnePost_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.CreateOnePost(childComplexity, args["authorUsername"].(string), args["title"].(string)), true
	...
	case "Mutation.createOneUser":
		...
		return e.complexity.Mutation.CreateOneUser(childComplexity, args["username"].(string)), true
	...
	case "Post.authorUsername":
		if e.complexity.Post.AuthorUsername == nil {
			break
		}

		return e.complexity.Post.AuthorUsername(childComplexity), true
...
func (ec *executionContext) field_Mutation_createOnePost_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["authorUsername"]; ok {
...
func (ec *executionContext) _Mutation_createOnePost(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
	...
	args, err := ec.field_Mutation_createOnePost_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateOnePost(rctx, args["authorUsername"].(string), args["title"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_createOneUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateOneUser(rctx, args["username"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "createOnePost":
			out.Values[i] = ec._Mutation_createOnePost(ctx, field)
